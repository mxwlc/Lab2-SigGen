...
VL_INLINE_OPT void Vsigdelay___024root___sequent__TOP__1(Vsigdelay___024root* vlSelf) {
    ...
    CData/*0:0*/ __Vdlyvset__sigdelay__DOT__signal_ram__DOT__ram_array__v0;
    // Body
    __Vdlyvset__sigdelay__DOT__signal_ram__DOT__ram_array__v0 = 0U;
    if (vlSelf->rd) {
    ...
    if (vlSelf->wr) {
        __Vdlyvval__sigdelay__DOT__signal_ram__DOT__ram_array__v0 
            = vlSelf->mic_signal;
        __Vdlyvset__sigdelay__DOT__signal_ram__DOT__ram_array__v0 = 1U;
        __Vdlyvdim0__sigdelay__DOT__signal_ram__DOT__ram_array__v0 
            = (0x1ffU & ((IData)(vlSelf->sigdelay__DOT__address) 
                         + (IData)(vlSelf->offset)));
    }
    if (__Vdlyvset__sigdelay__DOT__signal_ram__DOT__ram_array__v0) {
