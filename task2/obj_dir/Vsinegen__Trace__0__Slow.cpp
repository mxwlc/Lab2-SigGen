...
VL_ATTR_COLD void Vsinegen___024root__trace_init_sub__TOP__0(Vsinegen___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+5,"data1", false,-1, 7,0);
    tracep->declBus(c+6,"data2", false,-1, 7,0);
    ...
    tracep->pushNamePrefix("offset1 ");
    tracep->declBus(c+9,"WIDTH", false,-1, 31,0);
    tracep->declBus(c+7,"counter_input", false,-1, 7,0);
    tracep->declBus(c+1,"offset", false,-1, 7,0);
    tracep->declBus(c+8,"offset_address", false,-1, 7,0);
    tracep->popNamePrefix(1);
...
VL_ATTR_COLD void Vsinegen___024root__trace_full_sub_0(Vsinegen___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullCData(oldp+5,(vlSelf->data1),8);
    bufp->fullCData(oldp+6,(vlSelf->data2),8);
